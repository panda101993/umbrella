...
componentDidMount(){
console.log("getting all the details from one page",this.props.navigation.state.params.itemofAddress)
this.setState({
    firstname:this.props.navigation.state.params.itemofAddress.first_name,
    lastname:this.props.navigation.state.params.itemofAddress.last_name,
    phoneNumber:this.props.navigation.state.params.itemofAddress.mobile_no,
    transportName:this.props.navigation.state.params.itemofAddress.transport_name,
    postcode:this.props.navigation.state.params.itemofAddress.postal_code,
    address:this.props.navigation.state.params.itemofAddress.address,
    address_id:this.props.navigation.state.params.itemofAddress.id
   ...
   updateAddress(){
    ...
    ApiRequest(variables, "user-management/address", "PUT",`JWT ${this.props.Token}`)
      .then(async resp => {
                ...
                <KeyboardAvoidingView style={style.container1} behavior={Platform.OS === 'ios' ? "padding" : null} enabled>
                    <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            {/* <View style={style.headerView}>
                                <CustomHeader
                                    title="Add Address"
                                    source={Icon.NotificationIcon}
                                    HeadertextStyle={{ color: '#ffffff', fontSize: 22, marginHorizontal: wp('3%'), fontWeight: 'bold' }}
                                />
                            </View> */}
  ...
  style={{
      ...
      <Text style={{ color: '#23a7fa', fontWeight: '700' }}> C A N C E L</Text>
          ...
          >
              <Text style={{ color: '#ffffff', fontWeight: '700' }}> U P D A T E</Text>
          </TouchableOpacity>
      </View>
